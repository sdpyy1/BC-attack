...
def read_config():
    ...
    # 攻击方式
    parser.add_argument('--attack', type=str, default='lp_attack', help='attack method')
    # 不懂？
    ...
    parser.add_argument('--attack_goal', type=int, default=-1,help="trigger to which label")
    # 只有模型ACC达到某个值时开始进行攻击
